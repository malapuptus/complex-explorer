...
export const EXPECTED_HASHES: Readonly<Record<string, string>> = {
  "demo-10@1.0.0":
    "703387c3dee2fc429df5b478e20916e77e15cb949ea31a2fb1d6067eb8714201",
  "kent-rosanoff-1910@1.0.0":
    "31ab5dd87c812e7204231c8756ed3e2572befdb611a7320aaf601cedfbbbf210",
};

/**
 * Compute SHA-256 hex digest of `words.join("\n")`.
 */
export async function computeWordsSha256(
